...
export const task1Prompts: Task1Prompt[] = [
  ...
  task1Prompt(
    ...
    "bar",
    "work",
    "bar chart compares the average weekly hours spent on paid work and leisure by adults in five countries in 2025",
    "Grouped bar chart comparing weekly hours of paid work and leisure in Ardin, Belvar, Corvia, Dastan and Estell",
  ),
  task1Prompt(
    "t1-16",
    "line",
    "technology",
    "line graph shows the percentage of households with internet access in three regions from 2005 to 2025",
    "Line graph showing household internet access in the North, Central and South regions from 2005 to 2025",
  ),
  task1Prompt(
    "t1-17",
    "pie",
    "transport",
    "pie charts compare the reasons people travelled in one city in 2005 and 2025",
    "Two pie charts comparing travel for work, education, shopping, leisure and other reasons in 2005 and 2025",
  ),
  task1Prompt(
    "t1-18",
    "table",
    "tourism",
    "table gives information about international visitors to six national parks in 2025",
    "Table comparing visitor numbers, average stays and satisfaction rates at six national parks in 2025",
  ),
  task1Prompt(
    "t1-19",
    "process",
    "food",
    "diagram illustrates how coffee beans are processed and prepared for sale",
    "Seven-stage process diagram showing coffee cherries being harvested, dried, hulled, sorted, roasted, ground and packaged",
  ),
  task1Prompt(
    "t1-20",
    "map",
    "cities",
    "maps show the changes to a town centre between 2010 and 2025",
    "Two maps comparing a town centre in 2010 and 2025, including pedestrianisation, new housing and relocated parking",
  ),
  task1Prompt(
    "t1-21",
    "mixed",
    "health",
    "bar chart and table give information about exercise habits among adults in four age groups in 2025",
    "Combined bar chart and table comparing weekly exercise participation, average session length and preferred activities by age group",
  ),
];
